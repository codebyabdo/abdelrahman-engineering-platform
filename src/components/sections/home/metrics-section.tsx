...
const ENGINEERING_SNAPSHOT = [
  ...
  },
  {
    ...
    description: "Modern production-ready applications",
    icon: Layers3,
  },
  {
    value: "TypeScript",
    label: "Primary Language",
    description: "Typed and maintainable frontend systems",
    icon: Code2,
  },
  {
    value: "SaaS",
    label: "Product Experience",
    description: "Dashboards and multi-tenant platforms",
    icon: Server,
  },
  {
    value: "10+",
    label: "Commercial Projects",
    description: "Web applications and client projects",
    icon: Workflow,
  },
] as const;
        ...
        <div className="flex flex-col gap-3 border-b border-white/10 pb-4 sm:flex-row sm:items-end sm:justify-between sm:pb-6 md:gap-4">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 max-w-xl text-xs leading-relaxed text-white/45 sm:mt-3 sm:text-sm">
              A quick overview of the technologies, products, and engineering
          ...
          {ENGINEERING_SNAPSHOT.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-3 transition-all duration-300 hover:border-blue-500/30 hover:bg-white/10 sm:rounded-2xl sm:p-4 lg:p-5"
              >
                {/* Hover glow */}
                <div
                  aria-hidden="true"
