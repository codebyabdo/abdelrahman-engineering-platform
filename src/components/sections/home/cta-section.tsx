  ...
  return (
    <section className="relative overflow-hidden px-4 sm:px-6">
      ...
      >
        ...
        <div className="absolute bottom-0 left-1/2 h-px w-3/4 -translate-x-1/2 bg-linear-to-r from-transparent via-blue-500/30 to-transparent" />
      </div>

      <div className="relative mx-auto max-w-4xl overflow-hidden rounded-2xl border border-white/10 bg-white/5 px-4 py-10 text-center backdrop-blur-sm sm:rounded-3xl sm:px-8 sm:py-14 md:px-10 md:py-16">
        {/* Subtle inner glow */}
        <div
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-0 h-32 w-64 -translate-x-1/2 rounded-full bg-blue-500/5 blur-3xl"
        />
        ...
        >
          ...
          <StaggerItem>
            <h2 className="mx-auto max-w-2xl text-2xl font-semibold tracking-tight text-white sm:text-3xl md:text-4xl lg:text-5xl">
              ...
              <span className="block text-white/45">
                Let&apos;s build the frontend properly.
              </span>
            </h2>
          </StaggerItem>
          ...
          <StaggerItem>
            <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-white/50 sm:mt-5 sm:text-base">
              I&apos;m available for frontend engineering opportunities,
              freelance projects, and product teams building modern web
          ...
          {/* Value statement */}
          <StaggerItem>
            <div className="mt-5 max-w-2xl border-l border-blue-500/30 pl-4 text-left sm:mt-6 sm:pl-5">
              <p className="text-xs leading-relaxed text-white/40 sm:text-sm">
                My focus is on scalable frontend architecture, reusable
                component systems, responsive interfaces, performance, and
          ...
          {/* Availability */}
          <StaggerItem>
            <div className="mt-6 flex flex-wrap items-center justify-center gap-1.5 text-[9px] font-medium uppercase tracking-widest text-white/30 sm:mt-8 sm:gap-2 sm:text-[10px]">
          ...
          <FadeUp delay={0.4} duration={0.5}>
            <p className="mt-4 text-[9px] text-white/20 sm:text-[10px]">
